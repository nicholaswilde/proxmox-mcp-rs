# Contributing to Proxmox MCP RS

First off, thank you for considering contributing to Proxmox MCP RS! It's people like you that make the open-source community such an amazing place.
...
- Your environment details (OS, Rust version, Proxmox version).
